...
{
	XMLDocument doc;
	doc.LoadFile( "resources/2DFrameTest.xml" );
...
int example_3()
{
	...
	XMLElement* titleElement = doc.FirstChildElement( "Frame2D" )->FirstChildElement( "title" );
...
int main( int argc, const char ** argv )
{
	...
	FILE* fp = fopen( "resources/2DFrameTest.xml", "r" );
	if ( !fp ) {
	...
	return doc.ErrorID();
	//XMLTest( "2DFrameTest", 0, example_1() );
